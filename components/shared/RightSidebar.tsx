...
const RightSidebar = () => {
  const hotQuestions = [
    { _id: "1", title: "How do I use express as custom server in NextJS 1?" },
    { _id: "2", title: "How do I use express as custom server in NextJS 2?" },
    { _id: "3", title: "How do I use express as custom server in NextJS 3?" },
    { _id: "4", title: "How do I use express as custom server in NextJS 4?" },
    { _id: "5", title: "How do I use express as custom server in NextJS 5?" },
  ];
